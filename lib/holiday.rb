...
=begin
  winter_supplies = [] 
  outer_counter = 0 
  while outer_counter < holiday_hash[:winter].size 
    inner_counter = 0 
    while inner_counter < holiday_hash[:winter][inner_counter].size 
      winter_supplies << holiday_hash[:winter][:holiday][inner_counter] 
      inner_counter += 1
    end
    outer_counter += 1 
  end 
